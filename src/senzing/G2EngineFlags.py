...
class G2EngineFlags(IntFlag):
    ...
    G2_EXPORT_INCLUDE_ALL_ENTITIES = G2_EXPORT_INCLUDE_MULTI_RECORD_ENTITIES | G2_EXPORT_INCLUDE_SINGLE_RECORD_ENTITIES
    G2_EXPORT_INCLUDE_ALL_HAVING_RELATIONSHIPS = G2_EXPORT_INCLUDE_POSSIBLY_SAME | G2_EXPORT_INCLUDE_POSSIBLY_RELATED | G2_EXPORT_INCLUDE_NAME_ONLY | G2_EXPORT_INCLUDE_DISCLOSED
    ...
    G2_ENTITY_INCLUDE_INTERNAL_FEATURES = (1 << 23)
    G2_ENTITY_INCLUDE_FEATURE_STATS = (1 << 24)
    G2_ENTITY_INCLUDE_FEATURE_ELEMENTS = (1 << 32)

    # Flags for extra matching data.

    G2_INCLUDE_MATCH_KEY_DETAILS = (1 << 34)
    ...
    G2_FIND_PATH_DEFAULT_FLAGS = G2_FIND_PATH_INCLUDE_MATCHING_INFO | G2_ENTITY_INCLUDE_ENTITY_NAME | G2_ENTITY_INCLUDE_RECORD_SUMMARY
    G2_FIND_NETWORK_DEFAULT_FLAGS = G2_FIND_NETWORK_INCLUDE_MATCHING_INFO | G2_ENTITY_INCLUDE_ENTITY_NAME | G2_ENTITY_INCLUDE_RECORD_SUMMARY
    G2_WHY_ENTITIES_DEFAULT_FLAGS = G2_ENTITY_DEFAULT_FLAGS | G2_ENTITY_INCLUDE_INTERNAL_FEATURES | G2_ENTITY_INCLUDE_FEATURE_STATS | G2_INCLUDE_FEATURE_SCORES
    G2_WHY_RECORDS_DEFAULT_FLAGS = G2_ENTITY_DEFAULT_FLAGS | G2_ENTITY_INCLUDE_INTERNAL_FEATURES | G2_ENTITY_INCLUDE_FEATURE_STATS | G2_INCLUDE_FEATURE_SCORES
    G2_WHY_RECORD_IN_ENTITY_DEFAULT_FLAGS = G2_ENTITY_DEFAULT_FLAGS | G2_ENTITY_INCLUDE_INTERNAL_FEATURES | G2_ENTITY_INCLUDE_FEATURE_STATS | G2_INCLUDE_FEATURE_SCORES
    G2_HOW_ENTITY_DEFAULT_FLAGS = G2_INCLUDE_FEATURE_SCORES
    G2_VIRTUAL_ENTITY_DEFAULT_FLAGS = G2_ENTITY_DEFAULT_FLAGS

    G2_SEARCH_BY_ATTRIBUTES_ALL = G2_SEARCH_INCLUDE_ALL_ENTITIES | G2_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES | G2_ENTITY_INCLUDE_ENTITY_NAME | G2_ENTITY_INCLUDE_RECORD_SUMMARY | G2_INCLUDE_FEATURE_SCORES
    G2_SEARCH_BY_ATTRIBUTES_STRONG = G2_SEARCH_INCLUDE_RESOLVED | G2_SEARCH_INCLUDE_POSSIBLY_SAME | G2_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES | G2_ENTITY_INCLUDE_ENTITY_NAME | G2_ENTITY_INCLUDE_RECORD_SUMMARY | G2_INCLUDE_FEATURE_SCORES
